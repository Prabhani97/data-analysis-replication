...
```{r}
knitr::opts_chunk$set(fig.path = "images/Chunk_images")
```
...
#### Replicated results : Are in the "cor_table_wide" variable generated. ( Here also, **( I am not going to paste the table here again because it is a complex table but I am going to write the results summary below),** 
