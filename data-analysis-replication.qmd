...
-   Careful interpretation was needed to find the right variables and match them with those utilized in the original study.

-   Additionally, fitting several regression models and summarizing findings across conditions made it difficult to execute more advanced analyses, such dominance analysis.
...
The original study's lack of methodological detail was a major contributing factor to these difficulties. Although the work provided a conceptual description of the broad analytical methodologies, it omitted important implementation specifics such variable scaling, treatment of missing values, data preprocessing stages, and the precise computational procedures utilized for dominance analysis. Similarly, there was no explicit reporting of display characteristics such as statistical annotations, scaling, and smoothing.

missing details in the original study

Minor numerical and visual discrepancies between the replicated and original results may be explained by the need to make appropriate assumptions during replication due to the lack of these details. Notwithstanding these drawbacks, the general consistency in patterns and interpretations shows that the replication was reliable and effectively conveyed the study's main conclusions.

## References

1\) The study referred - link

2)Dominance analysis - Humes et al. 2021 - <https://doi.org/10.3389/fnagi.2021.702739>
