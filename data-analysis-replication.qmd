...
![Mean audiograms for the two listener groups](images/Mean%20audiograms%20for%20the%20two%20listener%20groups_original.png){width="400"}

#### Replicated mean audiogram values for the two groups

![Replicaed mean audiograms for the two listener groups](images/Replicated%20mean%20audiogram.png){width="500"}
...
![Violin plots for the four predictor variables](images/Violin%20plots%20for%20the%20four%20predictor%20variables_original.jpg)
...
![Replicated violin plots for the four predictor variables.](images/Replicated%20violin%20plots%20for%20the%20four%20predictor%20variables.jpg)
...
![Results of the dominance analysis](images/Results%20of%20the%20dominance%20analysis_original.jpg){width="500"}
...
![Example plot of the replicated results of the dominance analysis.](images/Replicated%20results%20of%20the%20dominance%20analysis_1)

### [Comparison of analysis 4: Second descriptive analysis: Correlation analysis]{.underline}

#### Original study : **Table 3. Correlation matrix of predictor variables with the three speech recognition outcome datasets. ( I am not going to paste the table here again because it is a complex table), I will just put a screenshot here, this is not a figure, so it is not in the images folder.**

![](images/clipboard-187466058.png)

#### Replicated results : Are in the "cor_table_wide" variable generated. ( Here also, **( I am not going to paste the table here again because it is a complex table but I am going to write the results summary below), I will show a preview of my generated results as follows, I will just put a screenshot here, this is not a figure, so it is not in the images folder.**

![](images/clipboard-3897672474.png)
