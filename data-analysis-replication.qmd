...
```{r}
# Installed the packages "corrplot" and "combinat" and loading the necessary libraries, I have removed installing code lines after installing
...
![Mean audiograms for the two listener groups](images/Mean audiograms for the two listener groups_original.png){width="400"}

#### Replicated mean audiogram values for the two groups

![Replicaed mean audiograms for the two listener groups](images/Replicated mean audiogram.png){width="500"}
...
![Violin plots for the four predictor variables](images/Violin plots for the four predictor variables_original.jpg)
...
![Replicated violin plots for the four predictor variables.](images/Replicated violin plots for the four predictor variables.jpg)
...
![Results of the dominance analysis](images/Results of the dominance analysis_original.jpg){width="500"}
...
![Example plot of the replicated results of the dominance analysis.](images/Replicated results of the dominance analysis_1)
